...
@pytest.mark.parametrize('flight, expected', [('not flight', None),
                                              ...
                                              (Flights(origin_country_id=1, destination_country_id=2,
                                                       departure_time=datetime(2022, 1, 30, 16, 0, 0),
                                                       landing_time='not datetime', remaining_tickets=200), None),
                                              (Flights(origin_country_id=1, destination_country_id=2,
                                                       departure_time=datetime(2022, 1, 30, 16, 0, 0),
                                                       landing_time=datetime(2022, 1, 30, 20, 0, 0),
                                                       remaining_tickets=100.7), None),
                                              (Flights(origin_country_id=1, destination_country_id=2,
                                                       departure_time=datetime(2022, 1, 30, 16, 0, 0),
                                                       landing_time=datetime(2022, 1, 30, 20, 0, 0),
                                                       remaining_tickets=99), None),
                                              (Flights(origin_country_id=1, destination_country_id=2,
...
def test_airline_facade_add_flight_raise_notlegalflighttimeserror(airline_facade_object):
    with pytest.raises(FlightTimesException):
        airline_facade_object.add_flight(Flights(origin_country_id=1, destination_country_id=2,
                                                 departure_time=datetime(2022, 1, 30, 17, 0, 0),
                                                 landing_time=datetime(2022, 1, 30, 17, 59, 0), remaining_tickets=100))
...
@pytest.mark.parametrize('flight, expected', [('not flight', None),
                                              (Flights(airline_company_id=3, origin_country_id=1,
                                                       destination_country_id=2,
                                                       departure_time=datetime(2022, 1, 30, 16, 0, 0),
                                                       landing_time=datetime(2022, 1, 30, 20, 0, 0),
                                                       remaining_tickets=200), None),
                                              (Flights(airline_company_id=1, origin_country_id=3,
                                                       destination_country_id=2,
                                                       departure_time=datetime(2022, 1, 30, 16, 0, 0),
                                                       landing_time=datetime(2022, 1, 30, 20, 0, 0),
                                                       remaining_tickets=200), None),
                                              ...
                                              (Flights(airline_company_id=1, origin_country_id=1,
                                                       ...
                                                       departure_time=datetime(2022, 1, 30, 16, 0, 0),
                                                       landing_time=datetime(2022, 1, 30, 20, 0, 0),
                                                       remaining_tickets=-2), None),
                                              (Flights(id=3, airline_company_id=1, origin_country_id=2,
                                                       destination_country_id=1,
                                                       departure_time=datetime(2022, 1, 29, 17, 0, 0),
                                                       landing_time=datetime(2022, 1, 30, 14, 0, 0),
                                                       remaining_tickets=0), None),
                                              (Flights(id=2, airline_company_id=2, origin_country_id=2,
                                                       destination_country_id=1,
                                                       departure_time=datetime(2022, 1, 29, 17, 0, 0),
                                                       landing_time=datetime(2022, 1, 30, 14, 0, 0),
                                                       remaining_tickets=0), None),
                                              (Flights(id=1, airline_company_id=1, origin_country_id=2,
                                                       destination_country_id=1,
                                                       departure_time=datetime(2022, 1, 29, 17, 0, 0),
                                                       landing_time=datetime(2022, 1, 30, 14, 0, 0),
...
def test_airline_facade_update_flight_raise_notlegalflighttimeserror(airline_facade_object):
    with pytest.raises(FlightTimesException):
        airline_facade_object.update_flight(
            Flights(id=1, airline_company_id=1, origin_country_id=1, destination_country_id=2,
                    departure_time=datetime(2022, 1, 30, 17, 0, 0), landing_time=datetime(2022, 1, 30, 17, 59, 0),
